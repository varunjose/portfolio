...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm('service_atopqwi', 'template_6ieuew9', form.current, {
            ...
            <div className='contact__content'>
                ...
                <div className='contact__form-div'>
                    ...
                    <div className='contact__form-div contact__form-area'>
                        ...
                        <textarea type='text' cols='30' rows='10' className='contact__form-input' name='message' placeholder='Write your message'></textarea>
                    </div>
