...
const Data = () => {
  return (
    <div className='home__data'>
        <h1 className='home__title'>Varun Jose
        <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <p className='home__description'>An ideal software engineer with a 
            strong passion for full-stack development and data analysis.</p>
